...
const LAUNCH_EMAILS: LaunchEmail[] = [
  ...
  },
  {
    ...
    ctaLabel: "Découvrir mes 10 niches offertes",
    goal: "Ouvrir le cadeau 10 niches EbookStudio sur Trafic Affiliation",
    paragraphs: [
      "Vous voulez créer un ebook, mais vous ne savez pas encore quel sujet choisir ? C'est souvent là que tout se bloque : une idée trop large, trop concurrentielle ou sans lecteur clairement identifié.",
      "Pour vous aider à démarrer sur de bonnes bases, je vous offre une sélection de 10 niches EbookStudio. Elles vous permettront de repérer des sujets précis et de choisir plus facilement l'angle de votre prochain livre.",
