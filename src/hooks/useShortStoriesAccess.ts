...
/**
 * Droits d'accès au Générateur d'Histoires Courtes & Contes Illustrés.
 *
 * Accès accordé si :
 *  - Admin
 *  - Abonné plan Pro / Édition (plan_tier : editeur, auteur, lifetime, vip)
 *  - Achat one-shot 27 € du module (module_entitlements, module = 'short-stories')
 */
const PRO_TIERS = new Set(['editeur', 'auteur', 'lifetime', 'vip']);
const PAID_STATUSES = new Set(['active', 'completed', 'paid']);

export function useShortStoriesAccess() {
...
export default useShortStoriesAccess;
