    ...
    <Card className="p-6">
      ...
      <div className="space-y-4">
        <div>
          ...
          <Progress 
            value={(performance.totalSize / (1024 * 1024)) * 100} 
            className="h-2"
          />
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="p-4 bg-gray-50 rounded-lg">
            <div className="text-2xl font-bold">{performance.scriptCount}</div>
            <div className="text-sm text-gray-500">Scripts</div>
          </div>
          <div className="p-4 bg-gray-50 rounded-lg">
            <div className="text-2xl font-bold">{performance.styleCount}</div>
