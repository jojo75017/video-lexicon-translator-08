...
const SalesFaq: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Oui. Le prix normal passera à 197€ le 30 septembre 2026. Parce que j'accompagne les créateurs et que je veux rendre cet outil accessible, le tarif de lancement est à 67€ à vie avec toutes les futures mises à jour incluses. Profitez-en avant l'augmentation !"
    },
    {
