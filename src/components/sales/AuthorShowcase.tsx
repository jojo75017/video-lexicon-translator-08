    ...
    <section className="py-20 px-4 relative overflow-hidden">
      ...
      >
        ...
        <motion.div variants={fadeUp} custom={1} className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="rounded-2xl overflow-hidden border border-violet-500/20 shadow-2xl shadow-violet-500/10 hover:shadow-violet-500/20 transition-shadow duration-500">
            <img
              src={ebooksShowcase1}
        ...
        <motion.div variants={fadeUp} custom={3} className="text-center">
          <Button
            ...
            className="text-base px-8 py-5 h-auto rounded-2xl bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-500 hover:to-purple-500 shadow-lg shadow-violet-500/25 gap-2 group"
          >
