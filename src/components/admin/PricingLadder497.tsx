 ...
 * Tout Complet 497€) avec ses tunnels de paiement déjà branchés.
 */
const PricingLadder497: React.FC = () => {
  return (
    <div className="space-y-4">
      <p className="text-sm text-joy-ink/70">
        Le parcours commercial complet menant à <strong>497€</strong> : la base à 197€, les packs upsell
