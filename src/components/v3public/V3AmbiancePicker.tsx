...
export default function V3AmbiancePicker({ compact = false }: { compact?: boolean }) {
  ...
  return (
    <div className="rounded-[22px] border p-3 md:p-4" style={{ borderColor: 'var(--v3-border)', background: '#fff' }}>
      <div className="flex flex-wrap items-center justify-between gap-2">
        <span className="inline-flex items-center gap-1.5 text-[11px] font-bold uppercase tracking-widest" style={{ color: 'var(--v3-muted)' }}>
          <Palette className="h-3.5 w-3.5" /> Ambiance
        </span>
