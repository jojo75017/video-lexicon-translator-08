...
const NAV = [
  ...
  { section: 'Livres spéciaux', items: [
    { to: '/v3/livres/roman', label: 'Roman', icon: BookOpen },
    { to: '/v3/livres/cuisine', label: 'Cuisine', icon: Palette },
    { to: '/v3/livres/voyage', label: 'Voyage', icon: Package },
    { to: '/v3/livres/coloriage', label: 'Coloriage', icon: Palette },
    { to: '/v3/livres/bd', label: 'BD / Manga', icon: BookOpen },
    { to: '/v3/livres/documentaire', label: 'Documentaire', icon: FileText },
    { to: '/v3/livres/atlas', label: 'Atlas', icon: MapIcon },
    { to: '/v3/livres/encyclopedie', label: 'Encyclopédie', icon: BookOpen },
    { to: '/v3/livres/agenda', label: 'Agenda', icon: Clock },
    { to: '/v3/livres/journal', label: 'Journal', icon: FileText },
    { to: '/v3/livres/scolaire', label: 'Scolaire', icon: GraduationCap },
    { to: '/v3/livres/aquariophilie', label: 'Aquariophilie', icon: Sparkles },
    { to: '/v3/livres/oiseaux', label: 'Fiches oiseaux', icon: Sparkles },
    { to: '/v3/livres/saga', label: 'Saga multi-tomes', icon: BookOpen },
  ]},
