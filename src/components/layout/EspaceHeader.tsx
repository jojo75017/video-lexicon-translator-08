...
const PLANNER_TABS: Array<{ id: FamilyId; label: string; emoji: string; bg: string; bgActive: string; ring: string; match: string[] }> = [
  { id: 'planner',   label: 'Plan',     emoji: '📘', bg: 'bg-blue-100 text-blue-800 hover:bg-blue-200',           bgActive: 'bg-blue-500 text-white shadow-md shadow-blue-500/30',         ring: 'ring-blue-400/30',    match: ['planner', 'characters', 'templates', 'workflow-dashboard', 'url-import', 'doc-transform', 'projects', 'ebook-library', 'series'] },
  { id: 'writing',   label: 'Écrire',   emoji: '✍️', bg: 'bg-emerald-100 text-emerald-800 hover:bg-emerald-200', bgActive: 'bg-emerald-500 text-white shadow-md shadow-emerald-500/30',   ring: 'ring-emerald-400/30', match: ['writing', 'strict-proofread', 'toc', 'aichat', 'complete-workflow', 'humanize-anti-ia', 'natural-rewrite', 'expert-writing', 'multi-translator', 'tools', 'atlas', 'encyclopedia', 'documentary', 'agenda', 'scolaire', 'pedagogique', 'content-architect'] },
  { id: 'images',    label: 'Habiller', emoji: '🎨', bg: 'bg-violet-100 text-violet-800 hover:bg-violet-200',     bgActive: 'bg-violet-500 text-white shadow-md shadow-violet-500/30',     ring: 'ring-violet-400/30',  match: ['images', 'cover', 'cover-design-editor', 'back-cover', 'backcover', 'images-cover', 'images-generator', 'images-library', 'editorial-packaging'] },
  { id: 'export',    label: 'Publier',  emoji: '🚀', bg: 'bg-orange-100 text-orange-800 hover:bg-orange-200',     bgActive: 'bg-orange-500 text-white shadow-md shadow-orange-500/30',     ring: 'ring-orange-400/30',  match: ['export', 'kdp', 'kdp-prepublish-checklist', 'workflow-export', 'calibre-epub', 'audiobook', 'audio-express', 'audio', 'audit-pilot', 'kdp-keywords-pro'] },
