/** Script du message de lancement (vidéo ou podcast). Sans horodatage. */

export const LAUNCH_SCRIPT_LONG = `Si vous avez toujours voulu publier un livre sur Amazon, écoutez-moi deux minutes. Le 30 septembre, l'accès à vie à EbookStudio à 47 euros disparaît définitivement. Ensuite, ce sera un abonnement mensuel. Je vous explique pourquoi, et surtout ce que vous obtenez.
...
export const LAUNCH_SCRIPT_SHORT = `Le 30 septembre, l'accès à vie à EbookStudio à 47 euros disparaît. Ensuite, ce sera un abonnement.
...
Jusqu'au 30 septembre à minuit : 47 euros une seule fois, accès à vie, payable en trois fois. Après, uniquement l'abonnement. La nouvelle version ouvre le 1er octobre avec le premier mois offert.

Testez gratuitement votre premier chapitre, sans carte bancaire, ou prenez l'accès à vie avant le 30 septembre. Le lien est en dessous.`;
