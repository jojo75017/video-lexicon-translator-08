...
export const V3_MODULES: V3Module[] = [
  ...
  // LIVRES SPÉCIAUX (types de livres V2 réintégrés en V3/V4)
  { id: 'special-recipe-book',   pillar: 'edition', status: 'done', title: 'Livre de cuisine',
    description: 'Générateur de livre de cuisine : recettes, menus et fiches techniques structurés et prêts à publier.' },
  { id: 'special-travel-guide',  pillar: 'edition', status: 'done', title: 'Guide de voyage',
    description: 'Créez un guide de voyage complet : itinéraires, bonnes adresses et sections illustrées.' },
  { id: 'special-coloring-book', pillar: 'edition', status: 'done', title: 'Livre de coloriage',
    description: 'Générez un livre de coloriage : pages à colorier créées par IA, prêtes pour l\'impression KDP.' },
  { id: 'special-comic-book',    pillar: 'edition', status: 'done', title: 'BD / Manga',
    description: 'Studio BD / manga : planches, cases et bulles pour un livre illustré séquentiel.' },
  { id: 'special-documentary',   pillar: 'edition', status: 'done', title: 'Documentaire',
    description: 'Livre documentaire richement illustré et sourcé sur le thème de votre choix.' },
  { id: 'special-atlas',         pillar: 'edition', status: 'done', title: 'Atlas',
    description: 'Atlas thématique : cartes et fiches géographiques générées et insérées dans le livre.' },
  { id: 'special-encyclopedia',  pillar: 'edition', status: 'done', title: 'Encyclopédie',
    description: 'Encyclopédie thématique : articles structurés et cohérents sur un domaine.' },
  { id: 'special-agenda',        pillar: 'edition', status: 'done', title: 'Agenda / Planner',
    description: 'Planificateurs et pages datées : agendas, plannings et outils de suivi.' },
  { id: 'special-diary',         pillar: 'edition', status: 'done', title: 'Journal intime',
    description: 'Journaux et carnets guidés avec invites d\'écriture personnalisées.' },
  { id: 'special-scolaire',      pillar: 'edition', status: 'done', title: 'Manuel scolaire',
    description: 'Manuel scolaire : cours, exercices et corrigés adaptés au niveau visé.' },
  { id: 'special-pedagogique',   pillar: 'edition', status: 'done', title: 'Livre pédagogique',
    description: 'Contenus éducatifs progressifs et pédagogiques structurés par objectif.' },
  { id: 'special-aquarium',      pillar: 'edition', status: 'done', title: 'Aquariophilie',
    description: 'Fiches poissons et bacs : guide d\'aquariophilie illustré et documenté.' },
  { id: 'special-bird-sheet',    pillar: 'edition', status: 'done', title: 'Fiches oiseaux',
    description: 'Guide ornithologique : fiches oiseaux illustrées et descriptives.' },
  { id: 'special-multi-tome',    pillar: 'edition', status: 'done', title: 'Saga multi-tomes',
    description: 'Gérez une série cohérente sur plusieurs tomes : personnages, univers et continuité.' },
  ...
  { id: 'sales-estimator-bsr',         pillar: 'data', status: 'done', title: 'Estimateur de Ventes (BSR → revenus)',
  ...
  { id: 'keyword-explorer-amazon',     pillar: 'data', status: 'done', title: 'Recherche de Mots-clés Amazon',
  ...
  { id: 'keyword-rank-tracker',        pillar: 'data', status: 'done', title: 'Suivi de Positions (Rank Tracker)',
  ...
  { id: 'reverse-asin',                pillar: 'data', status: 'done', title: 'Reverse ASIN',
  ...
  { id: 'niche-scorecard',             pillar: 'data', status: 'done', title: 'Analyse & Score de Niche',
  ...
  { id: 'category-bsr-explorer',       pillar: 'data', status: 'done', title: 'Explorateur de Catégories & BSR',
  ...
  { id: 'competitor-review-analyzer',  pillar: 'data', status: 'done', title: 'Analyse d\'Avis Concurrents',
  ...
  { id: 'competitor-tracker',          pillar: 'data', status: 'done', title: 'Suivi de Concurrents',
  ...
  { id: 'amazon-ads-keyword-research', pillar: 'data', status: 'done', title: 'Recherche Mots-clés Amazon Ads',
