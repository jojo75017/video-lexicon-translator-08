...
export interface V3Agent {
  ...
  filter: AgentFilter;
  route: string;
  /** Visage du personnage (emoji couleur) + accent de la carte */
  face: string;
  accent: string;
}
...
export const V3_AGENTS: V3Agent[] = [
  {
    ...
    filter: 'fiction', route: '/v3/outils/sommaire-ultime', face: '👩‍🏫', accent: '#0F766E',
  },
  {
    ...
    filter: 'fiction', route: '/v3/create', face: '🧑‍💼', accent: '#1D4ED8',
  },
  {
    ...
    filter: 'enfants', route: '/v3/livres/histoires-illustrees', face: '👩‍🎨', accent: '#DB2777',
  },
  {
    ...
    filter: 'pratique', route: '/v3/create', face: '🧑‍🏫', accent: '#065F46',
  },
  {
    ...
    filter: 'pratique', route: '/v3/livres/cuisine', face: '👩‍🍳', accent: '#C2410C',
  },
  {
    ...
    filter: 'pratique', route: '/v3/livres/voyage', face: '🧑‍✈️', accent: '#0369A1',
  },
  {
    ...
    filter: 'enfants', route: '/v3/livres/coloriage', face: '👧', accent: '#9333EA',
  },
  {
    ...
    filter: 'vendre', route: '/v3/outils/espion-concurrents', face: '🕵️', accent: '#B45309',
  },
  {
    ...
    filter: 'publier', route: '/v3/cover-studio-pro', face: '👩‍🎤', accent: '#BE123C',
  },
  {
    ...
    filter: 'publier', route: '/v3/corriger', face: '🧓', accent: '#374151',
  },
  {
    ...
    filter: 'vendre', route: '/v3/donnees-kdp', face: '👩‍💻', accent: '#7C3AED',
  },
  {
    ...
    filter: 'publier', route: '/v3/outils/traduction', face: '🧑‍🎤', accent: '#0891B2',
  },
  {
    ...
    filter: 'fiction', route: '/v3/livres/bd', face: '🧑‍🎨', accent: '#4338CA',
  },
  {
    ...
    filter: 'pratique', route: '/v3/livres/atlas', face: '👩‍🔬', accent: '#047857',
  },
  {
    ...
    filter: 'pratique', route: '/v3/livres/documentaire', face: '🧑‍🔬', accent: '#1E40AF',
  },
  {
    ...
    filter: 'pratique', route: '/v3/livres/agenda', face: '👩‍💼', accent: '#A16207',
  },
  {
    id: 'oscar', num: '17', name: 'Oscar', role: 'Maître du jeu',
    mission: 'Livres de jeux, énigmes, sudokus, mots mêlés.',
    deliverables: ['Grilles & énigmes', 'Solutions', 'Niveaux progressifs'],
    filter: 'enfants', route: '/v3/livres/jeux-enigmes', face: '🤖', accent: '#EA580C',
  },
  {
    ...
    filter: 'pratique', route: '/v3/livres/oiseaux', face: '👩‍🌾', accent: '#15803D',
  },
  {
    ...
    filter: 'fiction', route: '/v3/livres/saga', face: '🧙', accent: '#6D28D9',
  },
  {
    id: 'zoe', num: '20', name: 'Zoé', role: 'Cheffe d’orchestre',
    ...
    filter: 'publier', route: '/v3/workflow', face: '🦾', accent: '#0F766E',
  },
];
