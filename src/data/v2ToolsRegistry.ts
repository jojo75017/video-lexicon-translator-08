...
export const V2_TOOLS: V2Tool[] = [
  ...
  { id: 'humanize-ai', label: 'HumanizeAI', description: 'Humanisez un texte et auditez son rythme, son vocabulaire et ses marqueurs stylistiques.', route: '/v3/outils/humanizer', icon: Wand2, category: 'analyse', badge: 'Nouveau', image: IMG.analyse },
