...
export const TUTORIELS: Tutoriel[] = [
  ...
  },
  {
    id: 'kdp-champs',
    category: 'export',
    title: "Que mettre dans chaque champ de la fiche KDP",
    description: "Le contenu exact à coller dans chaque champ Amazon KDP, et où le récupérer dans l'outil.",
    durationMin: 8,
    icon: FileUp,
    steps: [
      "Titre & sous-titre : récupérez-les depuis l'onglet Planner (titre validé par l'agent éditorial).",
      "Nom d'auteur et contributeurs : depuis l'onglet Settings (profil auteur).",
      "Description (4000 caractères max, HTML autorisé) : générée dans l'onglet Fiche KDP.",
      "7 mots-clés backend : copiez-les depuis l'outil Mots-clés KDP.",
      "2 catégories BISAC : depuis l'onglet Fiche KDP (bloc catégories suggérées).",
      "Tranche d'âge / public : laissez vide si ce n'est pas un livre jeunesse.",
      "Fichier manuscrit (PDF) + couverture (JPG) : depuis l'onglet Export.",
    ],
    targetRoute: '/ebook-planner',
    targetTab: 'kdp',
    ctaLabel: 'Ouvrir la fiche KDP',
  },
  {
    id: 'kdp-workflow',
    category: 'export',
    title: "Workflow complet de publication sur Amazon KDP",
    description: "L'enchaînement bout à bout, du manuscrit jusqu'à la mise en ligne.",
    durationMin: 12,
    icon: CheckCircle2,
    steps: [
      "Préparez le manuscrit dans Planner via les 15 agents P1-P15.",
      "Générez la couverture dans l'onglet Cover.",
      "Exportez le PDF intérieur et l'epub depuis l'onglet Export.",
      "Récupérez description, catégories et mots-clés dans l'onglet Fiche KDP.",
      "Sur kdp.amazon.com, créez un nouveau livre et collez chaque champ (voir tuto précédent).",
      "Lancez l'aperçu KDP et corrigez les erreurs éventuelles.",
      "Publiez et programmez la date de sortie.",
    ],
    targetRoute: '/ebook-planner',
    targetTab: 'kdp',
