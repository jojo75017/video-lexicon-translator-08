...
export const EDITION_AGENTS: EditionAgent[] = [
  ...
  { order: 10, department: 'Enrichissement du livre', role: "L'Illustrateur",
    ...
    moduleId: 'cover-studio-pro', route: '/v3/hub?tab=parcours&module=cover-studio-pro', tier: 'v4' },
  ...
  { order: 20, department: 'Fabrication', role: 'Le Directeur Artistique',
    ...
    moduleId: 'cover-studio-pro', route: '/v3/hub?tab=parcours&module=cover-studio-pro', tier: 'v3' },
