...
export const EDITION_AGENTS: EditionAgent[] = [
  ...
  { order: 32, department: 'Positionnement & Métadonnées', role: 'Le Vérificateur de Marque',
    mission: 'V4 : repère les risques de titres, marques et formulations sensibles avant publication.',
    moduleId: 'trademark-checker', tier: 'v4' },

  // ─────────── Étude de marché avancée (V4 uniquement) ───────────
  { order: 33, department: 'Étude de marché avancée', role: 'Le Cartographe Amazon',
  ...
  { order: 34, department: 'Étude de marché avancée', role: 'L’Estimateur BSR',
    mission: 'V4 : estime les ventes et revenus potentiels à partir du classement BSR.',
    moduleId: 'sales-estimator-bsr', tier: 'v4' },
  { order: 35, department: 'Étude de marché avancée', role: 'L’Explorateur de Mots-clés',
  ...
  { order: 36, department: 'Étude de marché avancée', role: 'Le Reverse ASIN Analyst',
    mission: 'V4 : remonte les mots-clés et positions concurrents à partir des livres du marché.',
    moduleId: 'reverse-asin', tier: 'v4' },
  { order: 37, department: 'Étude de marché avancée', role: 'Le Scoreur de Niche',
