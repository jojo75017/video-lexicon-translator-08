...
const UPSELLS: Upsell[] = [
  ...
  },
  {
    ...
    price: '97 €',
    suffix: '· paiement unique (SaaS / logiciel)',
    priceId: 'v3_upsell_docstudio_once',
    badge: 'Pro',
  ...
  {
    id: 'licence-commerciale',
    name: 'Licence commerciale étendue',
    price: '29 €',
    suffix: '· paiement unique · OFFERTE aux abonnés Auteur',
    priceId: 'v3_upsell_licence_once',
    badge: 'Offerte plan Auteur',
    desc: "Droit de revendre, publier et exploiter commercialement les livres générés — sans limite de copies, sur toutes les plateformes (Amazon KDP, Kobo, Apple Books, boutique perso).",
    longDesc: "La Licence commerciale étendue vous donne le droit exclusif d'exploiter commercialement les livres, couvertures et contenus générés avec Ebookstudio V3, sans limite de nombre de copies ni de plateformes de distribution. Elle est OFFERTE gratuitement à tous les abonnés du plan Auteur (59 €/mois). Pour les plans Débutant et Expert, elle est disponible en option à 29 € (paiement unique, à vie).",
    features: [
      'Revente illimitée sur Amazon KDP, Kobo, Apple Books, Google Play Books',
      'Publication sous votre propre nom d’auteur ou pseudonyme',
      'Utilisation commerciale des couvertures IA générées',
      'Distribution sur votre boutique personnelle (Shopify, WooCommerce…)',
      'Aucune redevance ni royalties à reverser',
      'Certificat de licence PDF nominatif',
    ],
