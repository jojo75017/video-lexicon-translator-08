        ...
        <div className="max-w-3xl mx-auto">
          ...
          <Accordion type="single" collapsible className="space-y-4">
            ...
            <AccordionItem value="item-9" className="border rounded-lg px-4 bg-card">
              ...
              <AccordionContent className="text-muted-foreground">
                Le tarif actuel de 67€ est un prix de lancement exceptionnel pour remercier nos premiers utilisateurs. Le 30 septembre 2026, le prix passera à 197€ pour refléter la valeur réelle de l'outil.
              </AccordionContent>
            </AccordionItem>
