...
const invoices: Invoice[] = [
  { id: 'INV-001', date: '1 Jan 2024', amount: '37€', status: 'payée' },
  { id: 'INV-002', date: '1 Déc 2023', amount: '37€', status: 'payée' },
  { id: 'INV-003', date: '1 Nov 2023', amount: '37€', status: 'payée' },
  { id: 'INV-004', date: '1 Oct 2023', amount: '37€', status: 'payée' },
];
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="space-y-2">
              ...
              <p className="text-2xl font-bold">37€<span className="text-sm font-normal text-muted-foreground"> unique</span></p>
            </div>
            <div className="space-y-2">
