...
import { ArrowLeft, Search, Globe, ExternalLink, Loader2, Copy, Download } from "lucide-react";
      ...
      <div className="container mx-auto pb-10">
        <Card className="p-6 mb-6 border-purple-500 border-t-4 bg-gradient-to-r from-purple-50/50 to-blue-50/50">
          <h2 className="text-2xl font-bold mb-2 bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">
            🚀 Générateur SERP Professionnel
          </h2>
          <p className="text-gray-600 mb-6">
            Générez instantanément les URLs des principaux sites français pour votre mot-clé. 
            Tous les liens sont cliquables et vous redirigent vers les vrais sites.
          </p>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="p-4 bg-white rounded-lg border border-green-200">
              <h3 className="font-semibold text-green-700 mb-2">🌐 Sites Réels</h3>
              <p className="text-sm text-gray-600">Booking, Expedia, Kayak, TripAdvisor...</p>
            </div>
            <div className="p-4 bg-white rounded-lg border border-blue-200">
              <h3 className="font-semibold text-blue-700 mb-2">🔗 Liens Cliquables</h3>
              <p className="text-sm text-gray-600">Accès direct aux vraies pages des sites</p>
            </div>
            <div className="p-4 bg-white rounded-lg border border-purple-200">
              <h3 className="font-semibold text-purple-700 mb-2">⚡ Export Facile</h3>
              <p className="text-sm text-gray-600">Copiez ou exportez toutes les URLs</p>
            </div>
          </div>
