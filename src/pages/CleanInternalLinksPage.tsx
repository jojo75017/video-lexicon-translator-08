...
import { Link2, Globe, Search, Loader2, Network, AlertTriangle, BarChart3, Users, Clock, ArrowLeft, Home } from 'lucide-react';
      ...
      <header className="bg-white shadow-sm border-b">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <h1 className="text-xl font-bold text-gray-900">SEO Tools - Liens Internes</h1>
...
export default CleanInternalLinksPage;
