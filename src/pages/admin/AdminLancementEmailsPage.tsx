...
const STEPS = [
  ...
  { step: 6, template: 'v3l-niches-offertes-relance-2', title: 'Relance cadeau — version plus convaincante', when: 'Relance' },
];
      ...
      <div className="mx-auto max-w-5xl px-4 py-6">
        ...
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Les emails envoyés avant le 1er octobre et les lettres cadeau « 10 niches », avec les envois et les clics. Chaque lettre contient un seul bouton vers la page cadeau.</p>
          </div>
