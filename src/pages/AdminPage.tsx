      ...
      <div className="container mx-auto max-w-6xl py-8 space-y-6">
          ...
          <form onSubmit={handleAddSubscriber} className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                disabled={isLoading}
              >
                <option value="lifetime">🌟 Lifetime - 67€ (Accès à vie)</option>
        ...
        <Card className="p-6 border-2 border-primary/20 bg-primary/5">
          ...
          <p className="text-sm text-muted-foreground mt-4">
            💡 <strong>Lors d'un achat (67€) :</strong> Ajoutez l'abonné ci-dessus, puis cliquez sur "Envoyer" pour lui envoyer son code par email automatiquement.
          </p>
        </Card>
