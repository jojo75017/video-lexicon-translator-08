...
const SeoGenerateurEbookPage: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "EbookiaPro propose un essai gratuit avec 3 plans d'ebooks. L'accès complet à vie est ensuite à 37€, incluant toutes les fonctionnalités et mises à jour futures."
    },
    {
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          "name": "EbookiaPro - Générateur Ebook IA",
      ...
      <footer className="py-8 px-4 bg-gray-900 text-gray-400 text-center text-sm">
        <p>© 2025 EbookiaPro - Le meilleur générateur d'ebook IA</p>
        <div className="flex justify-center gap-4 mt-4">
          <a href="/offres" className="hover:text-white transition-colors">Offres</a>
          <a href="/creer-ebook-ia" className="hover:text-white transition-colors">Créer ebook IA</a>
          <a href="/ecrire-livre-chatgpt" className="hover:text-white transition-colors">Écrire avec ChatGPT</a>
        </div>
      </footer>
    </div>
  );
