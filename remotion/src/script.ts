...
export const SCENES: Scene[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "Édition, quarante-sept euros par mois : des livres illimités, soixante chapitres, le studio de couvertures professionnel,",
      ...
      "L'ouverture a lieu le 1er octobre.",
    ],
  },
  {
    chapter: "Séquence 8",
    title: "Écrivez votre premier chapitre",
    motif: "closing",
    shot: "livres.jpg",
    shotCaption: "Écran réel : vos livres, prêts à publier.",
    chips: ["Plan ensemble", "Écriture avec mémoire", "Correction", "Publication"],
    lines: [
      "Vous avez vu l'essentiel : on construit le plan ensemble, on écrit chapitre par chapitre avec la mémoire du livre,",
      "on corrige comme une maison d'édition, puis on habille et on publie.",
      "Le pack de bienvenue est déjà là, sur la page d'accueil, sans carte bancaire.",
      "Prenez-le, lisez-le, et écrivez votre premier chapitre pour voir ce que cela donne avec votre sujet.",
